...
export const ProjectPreview = ({ project: p, onBack, onEdit }) => {
  ...
  const totalFields = p.chapters.reduce(
    (s, c) => s + c.items.reduce((ss, i) => ss + i.measurements.length, 0),
    0,
  );
  ...
  return (
    <div className="fade-up">
      ...
      <div className="stats-grid" style={{ marginBottom: 20 }}>
        ...
        <StatCard
          icon="📅"
          number={new Date(p.createdAt).toLocaleString("en-IN") || "—"}
          label="Created"
          color="var(--text2)"
        />
      </div>
          ...
          {p.chapters.map((ch) => (
            <div
              ...
              style={{
                ...
                cursor: "pointer",
                background:
                  activeChId === ch.id ? ch.color + "22" : "transparent",
        ...
        <div>
          {activeCh?.items.map((item) => (
            <div
              ...
              style={{
                marginBottom: 12,
                borderLeft: `3px solid ${activeCh.color}`,
              }}
            >
              <div
                style={{
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            {m.fixedNumber !== undefined && (
                              <span>fixed: {m.fixedNumber}</span>
                            )}
                            {m.fixedText !== undefined && (
                              <span>fixed: {m.fixedText}</span>
                            )}
                            {m.billingRate !== undefined && (
                              <span>rate: {m.billingRate}</span>
                            )}
                          </div>
