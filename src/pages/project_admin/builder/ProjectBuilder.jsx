      ...
      {p.Vault && (
        ...
        >
          ...
          >
            <div>
              <div
                style={{ fontSize: 10, color: "var(--text3)", marginBottom: 2 }}
              >
                Allotted
              </div>
              <div
          ...
          {p.Vault.allotedBudjet > 0 &&
            (() => {
              const pct = Math.min(
                100,
                Math.round((p.Vault.spentBudjet / p.Vault.allotedBudjet) * 100),
              );
              const barColor =
                pct > 85
                  ? "var(--red)"
...
export default function ProjectManagement() {
  ...
  const openBuilder = (proj = null) => {
    setActive(proj ? structuredClone(proj) : newProject());
    setView("builder");
  };
